...
class Weather:
    ...
    def get_weather(self, current_city_id, day):
        current_weather_url = "http://api.openweathermap.org/data/2.5/forecast?id=524901&APPID=55b0e437ce69c49bc5ee21454be8d7f7&units=metric&q=delhi"
        ...
        '''print(weather_list[1]['main']['temp'])
        print(weather_list['weather']['main'])
        print(weather_list['humidity'])'''
        #print(json_data['city']['country'])
        for i in json_data['list']:
            print(i)
        '''
        print('1',json_data_list['clouds'])
        print('2',json_data_list['rain'])
        print('3',json_data_list['sys'])
        print('4',json_data_list['dt_txt'])
        print('5',json_data_list['weather'])
        print('6',json_data_list['dt'])
        print('7',json_data_list['main'])
        print('8',json_data_list['wind'])'''
    ...
    def load_data_from_json(self, cur_json_list):
        ...
        t_temp = cur_json_list[u'weather']
